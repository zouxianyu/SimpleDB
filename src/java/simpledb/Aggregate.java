...
public class Aggregate extends Operator {
    ...
    public void open() throws NoSuchElementException, DbException,
        ...
        // push all tuples into the aggregator
        child.open();
        while (child.hasNext()) {
        ...
        // after the aggregator is done, create an iterator on the aggregator
    ...
    public TupleDesc getTupleDesc() {
        String aggregateName = nameOfAggregatorOp(aop)+"("+child.getTupleDesc().getFieldName(afield)+")";
	    if(gfield == Aggregator.NO_GROUPING) {
            return new TupleDesc(new Type[] { Type.INT_TYPE }, new String[] { aggregateName });
        }else{
            return new TupleDesc(new Type[] { child.getTupleDesc().getFieldType(gfield), Type.INT_TYPE }, new String[] { child.getTupleDesc().getFieldName(gfield), aggregateName });
        }
    }
